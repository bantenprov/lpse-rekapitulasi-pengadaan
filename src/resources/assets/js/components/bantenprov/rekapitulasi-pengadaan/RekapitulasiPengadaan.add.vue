...
miniToastr.init();
export default {
    name: "lpse_rekapitulasi_pengadaan_add",
    components: {
        Datepicker
    },
    data() {
        return {
            lpse_rekapitulasi_pengadaans: [],
            provinces: [],
            regencies: {},
            formstate: {},
            model: {
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/rekapitulasi-pengadaan/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/rekapitulasi-pengadaan/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/rekapitulasi-pengadaan/create'
                  }
                },
                window.location.href = '#/admin/rekapitulasi-pengadaan/create')
        ...
        back() {
            window.location = '#/admin/rekapitulasi-pengadaan';
        }
    },
    mounted: function() {
        axios.get("/rekapitulasi-pengadaan/create").then(response => {
